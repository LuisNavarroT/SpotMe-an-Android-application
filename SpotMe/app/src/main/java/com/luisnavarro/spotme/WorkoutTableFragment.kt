...
class WorkoutTableFragment : Fragment() {
    // create a reference variable for View Binding
    private lateinit var binding: FragmentWorkoutTableBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWorkoutTableBinding.inflate(inflater,container,false)
        sf = requireContext().getSharedPreferences("my_sf", AppCompatActivity.MODE_PRIVATE)

        binding.etNameDay1.setText(getData("title1",""))
        ...
        binding.btnTimer.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTableFragment_to_stopWatchFragment)
        }
        binding.btnHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTableFragment_to_mainMenuFragment)
        }
        binding.btnSaveData.setOnClickListener {
            editor = sf.edit()

            editor.putString("title1",binding.etNameDay1.text.toString())
