...
import com.luisnavarro.spotme.databinding.FragmentWorkoutTable5Binding
import com.luisnavarro.spotme.databinding.FragmentWorkoutTableBinding

class WorkoutTable5Fragment : Fragment() {
    // create a reference variable for View Binding
    private lateinit var binding: FragmentWorkoutTable5Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWorkoutTable5Binding.inflate(inflater,container,false)
        sf = requireContext().getSharedPreferences("my_sf5", AppCompatActivity.MODE_PRIVATE)

        binding.etNameDay5.setText(getData("title1",""))
        ...
        binding.btnTimer.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTable5Fragment_to_stopWatchFragment)
        }
        binding.btnHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTable5Fragment_to_mainMenuFragment)
        }
        binding.btnSaveData.setOnClickListener {
            editor = sf.edit()

            editor.putString("title1",binding.etNameDay5.text.toString())
