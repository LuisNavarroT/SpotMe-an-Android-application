...
import com.luisnavarro.spotme.databinding.FragmentWorkoutTable4Binding
import com.luisnavarro.spotme.databinding.FragmentWorkoutTableBinding


class WorkoutTable4Fragment : Fragment() {
    // create a reference variable for View Binding
    private lateinit var binding: FragmentWorkoutTable4Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWorkoutTable4Binding.inflate(inflater,container,false)
        sf = requireContext().getSharedPreferences("my_sf4", AppCompatActivity.MODE_PRIVATE)

        binding.etNameDay4.setText(getData("title1",""))
        ...
        binding.btnTimer.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTable4Fragment_to_stopWatchFragment)
        }
        binding.btnHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTable4Fragment_to_mainMenuFragment)
        }
        binding.btnSaveData.setOnClickListener {
            editor = sf.edit()

            editor.putString("title1",binding.etNameDay4.text.toString())
