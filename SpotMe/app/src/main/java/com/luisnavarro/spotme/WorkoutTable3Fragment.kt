...
import com.luisnavarro.spotme.databinding.FragmentWorkoutTable3Binding
import com.luisnavarro.spotme.databinding.FragmentWorkoutTableBinding


class WorkoutTable3Fragment : Fragment() {
    // create a reference variable for View Binding
    private lateinit var binding: FragmentWorkoutTable3Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWorkoutTable3Binding.inflate(inflater,container,false)
        sf = requireContext().getSharedPreferences("my_sf3", AppCompatActivity.MODE_PRIVATE)

        binding.etNameDay3.setText(getData("title1",""))
        ...
        binding.btnTimer.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTable3Fragment_to_stopWatchFragment)
        }
        binding.btnHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_workoutTable3Fragment_to_mainMenuFragment)
        }
        binding.btnSaveData.setOnClickListener {
            editor = sf.edit()

            editor.putString("title1",binding.etNameDay3.text.toString())
